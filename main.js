...
bot.on('ready', () => { 
bot.user.setActivity("StaffMe | -help || "  + bot.guilds.size + " serveurs")
}) 
...
bot.on('message', message => {
    ...
    if (command === "Kick") {
        ...
        kickMember.kick().then(member => {
            ...
            message.guild.channels.find("name", "general").send(`**${member.user.username} a été expulsé du discord par **${messaga.author.username}**`)
